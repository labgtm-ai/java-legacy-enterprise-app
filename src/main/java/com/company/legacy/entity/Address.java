...
public class Address implements Serializable {
    ...
    public void setAddressLine1(String addressLine1) {
        // SRAO: Replaced explicit null check with Optional for cleaner handling of potentially null input.
    ...
    public String getFullAddress() {
        ...
        // SRAO: Replaced explicit null checks with Optional.ifPresent for conditional appending.
