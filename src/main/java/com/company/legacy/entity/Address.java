...
public class Address implements Serializable {
    ...
    public String getFullAddress() {
        ...
        // SRAO: Replaced explicit null check with Optional.ofNullable().filter().ifPresent()
        ...
        // SRAO: Replaced explicit null check with Optional.ofNullable().ifPresent()
        Optional.ofNullable(country).ifPresent(s -> {
            buffer.append(", ");
            buffer.append(s);
        });

        // SRAO: Replaced explicit null check with Optional.ofNullable().ifPresent()
        Optional.ofNullable(zipCode).ifPresent(s -> {
            buffer.append(" - ");
            buffer.append(s);
        });
