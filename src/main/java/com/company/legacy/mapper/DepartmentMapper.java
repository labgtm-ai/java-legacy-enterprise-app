...
public class DepartmentMapper {
    ...
    public List<DepartmentResponse> toResponseList(
        ...
        // SRAO: Replaced explicit null check and traditional loop with Optional.ofNullable and stream API.
    ...
    public void updateEntity(
        ...
        // SRAO: Replaced explicit null checks on properties with Optional.ofNullable and ifPresent.
    ...
    public Department cloneDepartment(
        ...
        return Optional.ofNullable(department)
                .map(dept -> {
                    ...
                    copy.setLocation(dept.getLocation());
                    copy.setDescription(dept.getDescription());
                    copy.setActive(dept.getActive());
                    copy.setCreatedDate(dept.getCreatedDate());
                    copy.setLastModifiedDate(dept.getLastModifiedDate());
                    return copy;
                })
                .orElse(null);
    }
